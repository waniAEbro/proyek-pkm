    ...
    <table class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">{{$item->masa}} bulan</td>
                ...
                <td class="text-center">
                    <div class="d-flex justify-content-around">
                        <a rel="tooltip" href="/kelas/{{$item->id}}/edit" class="btn btn-success btn-sm btn-round btn-icon text-white">
                            <i class="now-ui-icons ui-2_settings-90"></i>
                        </a>
                        <form method="post" action="/kelas/{{$item->id}}" class="form-inline">
                            @method("delete")
                            @csrf
            ...
            @endforeach
            <tr>
                <td class="text-center" colspan="13">Tambah Kelas</td>
                <td class="text-center">
